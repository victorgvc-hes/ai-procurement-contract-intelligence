...
End-to-end contract intelligence platform for procurement: PDF ingestion, clause extraction, compliance analytics, and ChromaDB-backed RAG.
...
![Architecture Diagram](procurement_ai_architecture_FINAL.png)
